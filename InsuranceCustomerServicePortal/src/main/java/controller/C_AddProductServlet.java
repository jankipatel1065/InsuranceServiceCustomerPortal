...
/**
 * Servlet implementation class C_AddProductServlet
 */
@WebServlet("/C_AddProductServlet")
public class C_AddProductServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public C_AddProductServlet() {
        super();
